    ...
    const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        if (e.target.files && e.target.files[0]) {
            ...
            if (publicUrl) {
                ...
                await updateArtistProfile({ gallery: newGallery });
        ...
        <div>
            ...
            {gallery.length > 0 ? (
                ...
                <EmptyState
                    ...
                    message="Adicione fotos de shows, ensaios ou material de divulgação para que os contratantes vejam seu trabalho."
                />
            )}
        </div>
    );
