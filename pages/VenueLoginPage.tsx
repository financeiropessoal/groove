            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-gray-800 p-8 rounded-lg shadow-2xl">
                    ...
                    <div className="text-center mt-4 text-sm text-gray-400">
                      <p>Não tem conta? <Link to="/venue-signup" state={{ from }} className="text-red-400 hover:underline">Cadastre-se</Link></p>
                       <p className="mt-2">É um artista? <Link to="/login" className="text-red-400 hover:underline">Login de Artista</Link></p>
                    </div>
                </div>
            </div>
        </div>
