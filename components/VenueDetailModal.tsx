...
const VenueDetailModal: React.FC<VenueDetailModalProps> = ({ venue, onClose }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-gray-800 w-full h-full md:max-w-6xl md:h-[95vh] rounded-none md:rounded-lg shadow-2xl flex flex-col" 
      ...
      >
        <div className="relative h-48 md:h-64 bg-cover bg-center flex-shrink-0" style={{ backgroundImage: `url(${venue.imageUrl})` }}>
            ...
            <div className="absolute bottom-0 left-0 p-6">
                ...
                <p className="text-lg text-gray-200 mt-1 drop-shadow-md"><i className="fas fa-map-marker-alt mr-2 text-red-400"></i>{venue.address}</p>
            </div>
        </div>
