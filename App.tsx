...
const App: React.FC = () => {
  ...
  const shouldHideHeaderFooter = isAuthPage || isAdminLoginPage;
  const isAdminSection = location.pathname.startsWith('/admin') && !isAdminLoginPage;
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen flex flex-col">
      ...
      <main className={`flex-grow ${!shouldHideHeaderFooter ? 'container mx-auto px-4 py-8' : ''}`}>
        <Routes>
          ...
          <Route element={<AdminProtectedRoute />}>
             <Route path="/admin/*" element={<AdminLayout><p>Admin Section</p></AdminLayout>} />
          </Route>
